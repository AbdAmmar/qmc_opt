...
def f_envSumGauss_j1eGauss(x, n_nuc, H_ind, n_par_env, n_par_j1e_coef, j1e_size):
    ...
    # UPDATE PARAMETERS
    set_env_expo(env_expo)
    set_j1e_coef(j1e_coef, j1e_size)
    set_j1e_expo(j1e_expo, j1e_size)
...
def init_envSumGauss_j1eGauss(n_nuc, H_nb):

    H_ind, H_nb, H_map = Hatom_map()
    ...
    args = (n_nuc, H_ind, n_par_env, n_par_j1e_coef, j1e_size)
