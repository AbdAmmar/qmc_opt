...
#    n_nuc, atom_map, H_ind, n_par_env, n_par_j1e_expo, j1e_size, ezfio = args
def f_envSumGauss_j1eGauss(x, n_nuc, atom_map, H_ind, n_par_env, n_par_j1e_expo, j1e_size, ezfio):
